...
download_folder = r"C:\Users\mohan.7482\Desktop\SEBI\pdfdownload"
...
def send_email(subject, message):
    ...
    # password = 'rovqljwppgraopla'  # If using Gmail, you may need to use an app password
...
def insert_excel_data_to_mysql(final_excel_sheets_path, cursor):
    ...
    try:
        ...
        log_list = [None] * 8
        traceback.print_exc()
        send_email("SEBI settlement order script error", e)
...
def move_files_to_specific_folder(file_name_excel_path, type_sebi_text):
    try:
        ...
        def save_to_excel():
            ...
            final_excel_sheets_path = fr"C:\Users\mohan.7482\Desktop\SEBI\final_excel_sheets\{final_excel_sheets_name}"
            ...
            if shadow_element:
                ...
                if print_preview_app :
                    ...
                    if shadow_element:
                        ...
                        shadow_element.click()
                        time.sleep(10)
                        file_name_with_path = fr"C:\Users\mohan.7482\Desktop\SEBI\pdfdownload\settlementorder_{name}_{index}.pdf"
...
def find_new_data(excel_file_path, db_table_name, type_sebi_text):
    ...
    try:
        ...
        new_excel_file_path = rf"C:\Users\mohan.7482\Desktop\SEBI\incremental_excel_sheets\Missing_Data_{type_sebi_text}_{current_date}.xlsx"
        missing_data_df = pd.DataFrame(missing_rows)
        missing_data_df.to_excel(new_excel_file_path, index=False)
        download_pdf_files(missing_data_df, type_sebi_text)  
        print(f"Missing rows saved to {new_excel_file_path}")
