...
def find_new_data(excel_file_path, db_table_name, type_sebi_text):
    ...
    try:
        ...
        select_query = f"SELECT link_to_order FROM {db_table_name} WHERE type_of_order = 'ao';"
        ...
        new_excel_file_path = rf"C:\Users\devadmin\sebi_final_script\ao\data\incremental_excel_sheets\Missing_Data_{type_sebi_text}_{sebi_config.current_date}.xlsx"
