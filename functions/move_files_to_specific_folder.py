...
from config.sebi_config import no_data_avaliable,no_data_scraped,source_name,source_status,current_date
...
def move_files_to_specific_folder(file_name_excel_path, type_sebi_text):
    try:
        ...
        main_folder_path = r"C:\inetpub\wwwroot\Sebi_apiproject\pdfdownload\ao"
        ...
        def save_to_excel():
            ...
            final_excel_sheets_path = fr"C:\Users\devadmin\sebi_final_script\ao\data\final_excel_sheets\{final_excel_sheets_name}"
